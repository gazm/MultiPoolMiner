...
set "command=& .\multipoolminer.ps1 -region us -wallet 1MiNERbHbLbchB8g7WpBw5p9X2AZPHEUHo -username gorgazm -workername BIGBOY -ssl -type nvidia -algorithm equihash,sib,neoscrypt,decred,lbry,bitcore,lyra2re2,m7m,skein,blake2s,blakecoin,xevan,hmq1725,x17,sia,c11,nist5,groestl,jha,tribus,skunk,phi,hsr,polytimos,lyra2z,pascal,siaclaymore,sia -poolname miningpoolhub,miningpoolhubcoins,zpool,ahashpool,hashrefinery,nicehash -currency btc,usd -interval 90 -watchdog -donate 10 -switchingprevention 5"
