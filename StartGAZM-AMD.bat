...
set "command=& .\multipoolminer.ps1 -region us -wallet 1MiNERbHbLbchB8g7WpBw5p9X2AZPHEUHo -username gorgazm -workername AMD -ssl -type amd -algorithm equihash,neoscrypt,decred,lyra2z,pascal,siaclaymore,ethash,cryptonight -poolname miningpoolhub,miningpoolhubcoins,zpool,ahashpool,hashrefinery,nicehash -currency btc,usd -interval 90 -watchdog -donate 10 -switchingprevention 5"
